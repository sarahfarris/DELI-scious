...
public class OrderScreen {
  ...
  public static void displayMenu() {
    ...
    System.out.printf("%-" + (itemColWidth + (priceColWidth * 3) + 6) + "s%n", "        SANDWICH ORDER MENU");
    System.out.println("=".repeat(itemColWidth + (priceColWidth * 3) + 6));

    // --- Price Header Row ---
    System.out.printf("%-" + itemColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s%n",
            "Item", "4\"", "8\"", "12\"");
    System.out.println("-".repeat(itemColWidth) + "+" + "-".repeat(priceColWidth + 2) + "+" + "-".repeat(priceColWidth + 2) + "+" + "-".repeat(priceColWidth + 2));


    // --- Bread Section ---
    System.out.printf("%n%-" + categoryColWidth + "s%n", "--- BREAD ---");
    System.out.printf("%-" + itemColWidth + "s | %" + priceColWidth + ".2f | %" + priceColWidth + ".2f | %" + priceColWidth + ".2f%n",
    ...
    System.out.printf("%-" + itemColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s%n",
            "Lettuce", "Included", "Included", "Included");
    System.out.printf("%-" + itemColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s%n",
            "Peppers", "Included", "Included", "Included");
    System.out.printf("%-" + itemColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s%n",
            "Onions", "Included", "Included", "Included");
    System.out.printf("%-" + itemColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s%n",
            "Tomatoes", "Included", "Included", "Included");
    System.out.printf("%-" + itemColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s%n",
            "Jalapeños", "Included", "Included", "Included");
    System.out.printf("%-" + itemColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s%n",
            "Cucumbers", "Included", "Included", "Included");
    System.out.printf("%-" + itemColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s%n",
            "Pickles", "Included", "Included", "Included");
    System.out.printf("%-" + itemColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s%n",
            "Guacamole", "Included", "Included", "Included");
    System.out.printf("%-" + itemColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s%n",
            "Mushrooms", "Included", "Included", "Included");


    // --- Sauces Section ---
    System.out.printf("%n%-" + categoryColWidth + "s%n", "--- SAUCES (Included) ---");
    System.out.printf("%-" + itemColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s%n",
            "Mayo", "Included", "Included", "Included");
    System.out.printf("%-" + itemColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s | %" + priceColWidth + "s%n",
            "Mustard", "Included", "Included", "Included");
